error id: file://<WORKSPACE>/Project/migrate_data/migratedata/build.sbt:
file://<WORKSPACE>/Project/migrate_data/migratedata/build.sbt
...
offset: 434
uri: file://<WORKSPACE>/Project/migrate_data/migratedata/build.sbt
text:
```scala
// build.sbt
